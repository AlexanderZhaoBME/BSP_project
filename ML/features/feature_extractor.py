...
class Features:
    ...
    def __init__(self, file_path, fs, feature_groups, labels):
    ...
    def extract_features(self, n_signals=None, show=False, normalize=True, polarity_check=True, template_before=0.2, template_after=0.4):
        ...
        for file_name in file_names:
            ...
            try:
                ...
                ts, signal_raw, signal_filtered, rpeaks, templates_ts, templates = self._preprocess_signal(
                    signal_raw=signal_raw, normalize=normalize,
    ...
    def _load_mat_file(self, file_name):
        ...
        tmp = sio.loadmat(os.path.join(self.file_path, file_name))['val'].astype('float64')
        n = len(tmp)
        return tmp.reshape((n,))

    def _preprocess_signal(self, signal_raw, normalize, polarity_check,
        ...
        templates, rpeaks = self._extract_templates(signal_raw, rpeaks, template_before, template_after)
